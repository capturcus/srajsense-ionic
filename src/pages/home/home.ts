...
import {AddMeasurementPage} from '../add-measurement/add-measurement';
...
export class HomePage {
  ...
  addMeasurement(datapoint: Datapoint) {
    this.navCtrl.push(AddMeasurementPage, {datapoint: datapoint});
  }
}
